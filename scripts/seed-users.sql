...
INSERT INTO public.users (
  ...
  'user',
  2500,
  '["Technology", "Artificial Intelligence", "Startups", "Coding", "Innovation"]'::jsonb,
  true,
  true,
...
INSERT INTO public.users (
  ...
  'user',
  1800,
  '["Outdoor", "Hiking", "Photography", "Travel", "Nature"]'::jsonb,
  true,
  true,
...
INSERT INTO public.users (
  ...
  'user',
  3200,
  '["Writing", "Poetry", "Literature", "Arts", "Culture"]'::jsonb,
  true,
  true,
...
INSERT INTO public.users (
  ...
  'community_admin',
  5000,
  '["Technology", "Leadership", "Community Building", "Startups", "Mentoring"]'::jsonb,
  true,
  true,
...
INSERT INTO public.users (
  ...
  'community_admin',
  4200,
  '["Arts", "Culture", "Design", "Photography", "Events"]'::jsonb,
  true,
  true,
...
INSERT INTO public.users (
  ...
  'super_admin',
  10000,
  '["Platform Management", "Community Moderation", "Technology"]'::jsonb,
  true,
  true,
...
INSERT INTO public.users (
  ...
  'user',
  2800,
  '["Business", "Networking", "Startups", "Investment", "Innovation"]'::jsonb,
  true,
  true,
