...
export default function EventDetailsPage({
  ...
  // Extract community ID from pathname: /communities/[communityId]/admin/events/[eventId]
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {isAdmin && communityId && (
              <Link href={communityId ? `/communities/${communityId}/admin/events/${eventId}/edit` : `/communities/admin/${eventId}/edit`}>
