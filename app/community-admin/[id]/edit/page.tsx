...
export default function EditCommunityPage({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        window.location.href = communityId ? `/community-admin/${communityId}` : "/community-admin"
      }, 1000)
    } catch (error: any) {
      ...
      <div className="bg-gradient-to-br from-slate-50 to-purple-50 min-h-screen relative">
        ...
        <div className="max-w-5xl mx-auto p-6 md:p-8 relative z-10">
          <div className="mb-6 flex items-center justify-between">
            ...
            <Link href={communityId ? `/community-admin/${communityId}` : "/community-admin"} className="inline-flex">
