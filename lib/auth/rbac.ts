...
export const ROUTE_ACCESS_RULES: RouteConfig[] = [
  ...
  { path: '/community/[id]', allowedRoles: ['user', 'community_admin', 'super_admin'] },
  ...
  { path: '/wishlist', allowedRoles: ['user', 'community_admin', 'super_admin'] },
  { path: '/store', allowedRoles: ['user', 'community_admin', 'super_admin'] },
  
  // Community Admin routes (community admins and super admins)
  { path: '/community-admin-registration', allowedRoles: ['community_admin', 'super_admin'] },
  { path: '/create-community', allowedRoles: ['community_admin', 'super_admin'] },
...
export const DEFAULT_REDIRECT_PATHS: Record<UserRole, string> = {
  user: '/dashboard',
  community_admin: '/community-admin-registration',
